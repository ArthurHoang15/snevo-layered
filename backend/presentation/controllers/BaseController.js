 ...
 * 
 * Ported from Snevo/backend/utils/BaseController.js → snevo-layered presentation layer
 * Import paths updated to use layered infrastructure
 */

import { HTTP_STATUS, VALIDATION_RULES } from '../../infrastructure/utils/constants.js';
import { ErrorHandler, ValidationError, AuthenticationError, AuthorizationError } from '../../infrastructure/errors/ErrorClasses.js';
...
export default class BaseController {
     ...
     */
    sendResponse(res, data = null, message = null, statusCode = HTTP_STATUS.OK) {
        const response = {
            success: true,
            ...(message && { message }),
            ...(data && { data })
    ...
    sendSuccess(res, data = null, message = null) {
        this.sendResponse(res, data, message, HTTP_STATUS.OK);
    }
